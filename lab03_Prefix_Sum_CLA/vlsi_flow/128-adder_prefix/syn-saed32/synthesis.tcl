...
read_file -format verilog adder_128bit_Prefix.v
read_file -format verilog Prefix_Sum_CLA_128bit.v
read_file -format verilog Prefix_Sum_CLG_128bit.v
read_file -format verilog Carry_Recur_Gen.v
read_file -format verilog Kogge_Stone_128bit.v
read_file -format verilog Full_Adder.v


current_design adder_128bit_Prefix

set design_name "adder_128bit_Prefix"
